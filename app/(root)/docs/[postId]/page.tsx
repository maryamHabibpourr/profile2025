  ...
  return (
    <section className="w-full h-fit-content py-4 px-4">
      ...
      >
        ...
        <p className="mt-0 text-sm text-gray-600 text-center fotn-semibold">
          {pubDate}
        </p>
        <article className="text-gray-800 font-semibold text-justify text-sm md:text-base">
          {content}
        </article>
        <section className="mt-4">
          <h3 className="text-red-800 font-bold text-lg">Related Blogs:</h3>
          <div className="flex flex-row gap-4 text-gray-600 font-semibold">
            {tags}
          </div>
        </section>
        <p className="mb-10">
